  ...
  extends Directory
{
  ...
  public static Rational CalculateFlashCompensationFromBytes(byte[] paramArrayOfByte)
  {
    if (paramArrayOfByte.length == 3)
    {
      int i = paramArrayOfByte[2];
      return new Rational(paramArrayOfByte[0] * paramArrayOfByte[1], i);
    }
    return null;
  }
    ...
    throws MetadataException
  {
    ...
    return CalculateFlashCompensationFromBytes(getByteArray(18));
  }
 ...
 * Qualified Name:     com.drew.metadata.exif.NikonType2MakernoteDirectory
