...
public class ba
  extends AsyncTask
{
  public ba(RegisterActivity paramRegisterActivity) {}
  
  protected fm a(Integer... paramVarArgs)
  {
    Object localObject = Utils.c(RegisterActivity.a().getText().toString(), "0", "1");
    try
    {
  ...
  protected void a(fm paramfm)
  {
    ...
    {
      Utils.a(RegisterActivity.b(), RegisterActivity.d(this.a));
      return;
    }
 ...
 * Qualified Name:     com.unionpay.upomp.bypay.other.ba
