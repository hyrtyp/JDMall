  ...
  implements TextWatcher
{
  ...
  public fp(PayItActivity paramPayItActivity) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      m = PayItActivity.i().getSelectionEnd();
    ...
    for (int n = 1;; n = 0)
    {
      PayItActivity.i().setText(str2);
      if (m == paramEditable.length()) {
        if (this.d > this.jdField_a_of_type_Int)
        {
          EditText localEditText5 = PayItActivity.i();
          int i7 = 0;
          if (n != 0) {
            i7 = 1;
          }
      ...
      for (;;)
      {
        ...
        this.c = str2.length();
        this.jdField_a_of_type_ComUnionpayUpompBypayActivityPayItActivity.jdField_b_of_type_Boolean = true;
        return;
        i = 0;
        break;
        ...
        if (this.d < this.jdField_a_of_type_Int)
        {
          EditText localEditText4 = PayItActivity.i();
          int i5 = m - 1;
          int i6 = 0;
          if (i5 < 0) {}
          for (;;)
        ...
        if (this.d == this.jdField_a_of_type_Int)
        {
          EditText localEditText3 = PayItActivity.i();
          int i4 = 0;
          if (n != 0) {
            i4 = 1;
          }
          ...
          {
            if (i != 0) {
              PayItActivity.i().setSelection(m + 1);
            } else {
              PayItActivity.i().setSelection(m - 1);
            }
          }
          ...
          {
            EditText localEditText2 = PayItActivity.i();
            int i3 = 0;
            if (n != 0) {
              i3 = 1;
            }
          ...
          else
          {
            if (this.d < this.jdField_a_of_type_Int)
            {
              EditText localEditText1 = PayItActivity.i();
              int i1 = m - 1;
              int i2 = 0;
              if (i1 < 0) {}
              for (;;)
            ...
            if (this.d == this.jdField_a_of_type_Int) {
              PayItActivity.i().setSelection(m);
            }
          }
        }
      }
  ...
  {
    PayItActivity.i().setInputType(2);
 ...
 * Qualified Name:     com.unionpay.upomp.bypay.other.fp
