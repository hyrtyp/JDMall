...
public class cb
  extends AsyncTask
{
  public cb(GetpassActivity paramGetpassActivity) {}
  
  protected fm a(Integer... paramVarArgs)
  {
    Object localObject = Utils.c(GetpassActivity.a().getText().toString(), "0", "6");
    try
    {
  ...
  protected void a(fm paramfm)
  {
    ...
    if (paramfm.c().equals("0000")) {
      Utils.a(GetpassActivity.b(), GetpassActivity.g(this.a));
    }
    for (;;)
    {
      paramfm.a();
 ...
 * Qualified Name:     com.unionpay.upomp.bypay.other.cb
