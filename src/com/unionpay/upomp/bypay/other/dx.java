  ...
  extends BaseAdapter
{
  ...
  private String[] jdField_a_of_type_ArrayOfJavaLangString = { "银联手机在线支付用户注册协议", "一、声明与承诺", "二、服务内容", "三、银联手机在线支付注册规则", "四、注册用户使用规则", "五、银联手机在线支付服务使用限制", "六、系统中断或故障", "七、完整协议", "八、协议的中止和终止", "九、法律适用与管辖" };
  private boolean[] jdField_a_of_type_ArrayOfBoolean = new boolean[10];
  ...
  public dx(UserProtocalActivity paramUserProtocalActivity, Context paramContext)
  {
  ...
  {
    if (paramView == null) {
      return new ei(this.jdField_a_of_type_ComUnionpayUpompBypayActivityUserProtocalActivity, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ArrayOfJavaLangString[paramInt], this.b[paramInt], this.jdField_a_of_type_ArrayOfBoolean[paramInt]);
    }
    ei localei = (ei)paramView;
    localei.a(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt]);
    localei.b(this.b[paramInt]);
    localei.a(this.jdField_a_of_type_ArrayOfBoolean[paramInt]);
    return localei;
  }
}
 ...
 * Qualified Name:     com.unionpay.upomp.bypay.other.dx
