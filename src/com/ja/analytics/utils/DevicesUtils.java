...
public class DevicesUtils
{
  ...
  private static String formatMacAddress(String paramString, Context paramContext)
  {
    ...
    if (paramString.equals("000000000000000"))
    {
      ...
      LogUtil.logD(TAG, "imei=null,mac=" + str);
    }
    return localObject;
  }
  ...
  private static String getValidDeviceUUIDByInstant(Context paramContext)
  {
    ...
    {
      return str2;
      str1 = PreferenceUtils.getSharedPreferences(paramContext, "__jd_mob_preference").getString("uuid", null);
  ...
  public static String readDeviceUUID(Context paramContext)
  {
    ...
    if (str1 != null)
    {
      LogUtil.logD(TAG, "readDeviceUUID() read deivceUUID -->> " + str1);
      return str1;
    }
    ...
    LogUtil.logD(TAG, "readDeviceUUID() create deivceUUID -->> " + str4);
    return str4;
  }
 ...
 * Qualified Name:     com.ja.analytics.utils.DevicesUtils
