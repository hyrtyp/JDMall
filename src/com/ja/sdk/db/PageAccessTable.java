...
public class PageAccessTable
{
  private static JSONArray JsonArray_ID = new JSONArray();
  public static final String PAGE_ACCESS_DATA = "page_access_data";
  public static final String SEND_DATE = "send_date";
  public static final String SEND_FLAG = "send_flag";
  public static final String TAG = "PageAccessTable";
  public static final String TB_NAME = "page_access_data_info";
  ...
  public static void closeSQLiteDatabase(Context paramContext)
  {
    ...
    //   3: ldc 19
    //   5: ldc 41
    //   7: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   10: pop
    //   11: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   14: astore_3
    //   15: aload_3
    //   16: ifnonnull +7 -> 23
    //   19: ldc 2
    //   21: monitorexit
    //   22: return
    //   23: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   26: invokevirtual 54	android/database/sqlite/SQLiteDatabase:close	()V
    //   29: aconst_null
    //   30: putstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   33: goto -14 -> 19
    //   36: astore_1
    //   37: ldc 2
    //   39: monitorexit
  ...
  public static void deletePageAccessDataItem(Context paramContext, int paramInt)
  {
    try
    {
      LogUtil.logD("PageAccessTable", " deletePageAccessDataItem(),Index:" + paramInt);
      if (mDb == null) {
      ...
      localSQLiteDatabase.delete("page_access_data_info", "_id =?", arrayOfString);
      return;
    }
    finally {}
  }
  
  public static void deletePageAccessDataTable()
  {
    LogUtil.logD("PageAccessTable", " deletePageAccessDataTable()=> ");
    if (mDb == null) {
      return;
    }
    mDb.execSQL("delete from page_access_data_info");
  }
  
  /* Error */
  public static JSONArray getAllPageAccessDataNotSendItem(Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: new 31	org/json/JSONArray
    //   6: dup
    //   7: invokespecial 34	org/json/JSONArray:<init>	()V
    //   10: astore_1
    //   11: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   14: ifnonnull +41 -> 55
    //   17: ldc 19
    //   19: ldc 102
    //   21: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   24: pop
    //   25: ldc2_w 103
    //   28: invokestatic 110	java/lang/Thread:sleep	(J)V
    //   31: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   34: astore 13
    //   36: aload 13
    //   38: ifnonnull +10 -> 48
    //   41: aconst_null
    ...
    //   52: putstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   55: ldc 19
    //   57: new 58	java/lang/StringBuilder
    //   60: dup
    //   61: ldc 112
    //   63: invokespecial 63	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   66: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   78: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   81: pop
    //   82: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   85: ldc 118
    //   87: iconst_1
    ...
    //   147: pop
    //   148: getstatic 36	com/ja/sdk/db/PageAccessTable:JsonArray_ID	Lorg/json/JSONArray;
    //   151: iload 5
    //   153: aload 4
    //   155: aload 4
    //   157: ldc 25
  ...
  /* Error */
  public static void insertPageAccessDataItem(Context paramContext, org.json.JSONObject paramJSONObject)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   39: aload 4
    //   41: ldc 13
    //   43: invokestatic 176	com/ja/sdk/pagevisit/PageAccessData:getSingleInstance	()Lcom/ja/sdk/pagevisit/PageAccessData;
    //   46: invokevirtual 179	com/ja/sdk/pagevisit/PageAccessData:getSendDate	()Ljava/lang/String;
    //   49: invokevirtual 170	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   52: aload 4
    //   54: ldc 16
    //   56: invokestatic 176	com/ja/sdk/pagevisit/PageAccessData:getSingleInstance	()Lcom/ja/sdk/pagevisit/PageAccessData;
    //   59: invokevirtual 183	com/ja/sdk/pagevisit/PageAccessData:getSendFalseFlag	()I
    ...
    //   68: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   71: ifnonnull +18 -> 89
    //   74: ldc 19
    //   76: ldc 194
    //   78: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    ...
    //   86: putstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   89: ldc 19
    //   91: new 58	java/lang/StringBuilder
    //   94: dup
    //   95: ldc 196
    //   97: invokespecial 63	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   100: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   112: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   115: pop
    //   116: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   119: ldc 22
    //   121: aconst_null
    //   122: aload 4
    ...
    //   149: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   152: pop
    //   153: goto -138 -> 15
    //   156: astore_2
    //   157: ldc 2
  ...
  {
    LogUtil.logD("PageAccessTable", " onCreate()=> ");
    paramSQLiteDatabase.execSQL("create table page_access_data_info" + " ( _id INTEGER PRIMARY KEY AUTOINCREMENT, page_access_data TEXT, send_date TEXT, send_flag TINYINT)");
  }
  
  public static void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    LogUtil.logD("PageAccessTable", " onUpgrade()=> ");
    paramSQLiteDatabase.execSQL("drop table if exists page_access_data_info");
  ...
  public static SQLiteDatabase openSQLiteDatabase(Context paramContext)
  {
    ...
    //   21: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   24: pop
    //   25: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   28: astore 4
    //   30: ldc 2
    //   32: monitorexit
    //   33: aload 4
    ...
    //   40: putstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   43: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   46: ifnonnull +17 -> 63
    //   49: ldc 19
    //   51: ldc 225
    //   53: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   56: pop
    //   57: aconst_null
    //   58: astore 4
    //   60: goto -30 -> 30
    //   63: ldc 19
    //   65: ldc 227
    //   67: invokestatic 47	com/ja/sdk/utils/LogUtil:logD	(Ljava/lang/String;Ljava/lang/String;)I
    //   70: pop
    //   71: getstatic 49	com/ja/sdk/db/PageAccessTable:mDb	Landroid/database/sqlite/SQLiteDatabase;
    //   74: astore 4
    //   76: goto -46 -> 30
    //   79: astore_1
    //   80: ldc 2
  ...
  public static void updatePageAccessDataSendFlagItem(Context paramContext, Integer paramInteger)
  {
    try
    {
      LogUtil.logD("PageAccessTable", "updatePageAccessDataSendFlagItem()=>");
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("send_flag", Integer.valueOf(PageAccessData.getSingleInstance().getSendOkFlag()));
      if (mDb == null)
      {
        LogUtil.logD("PageAccessTable", " updatePageAccessDataSendFlagItem, mDb == null ");
        mDb = DatabaseHelper.getDatabase(paramContext);
      }
      LogUtil.logD("PageAccessTable", " updatePageAccessDataSendFlagItem, mDb =:  " + mDb.toString());
      SQLiteDatabase localSQLiteDatabase = mDb;
      String[] arrayOfString = new String[1];
      arrayOfString[0] = paramInteger.toString();
      localSQLiteDatabase.update("page_access_data_info", localContentValues, "_id= ? ", arrayOfString);
      return;
    }
    finally {}
  }
 ...
 * Qualified Name:     com.ja.sdk.db.PageAccessTable
