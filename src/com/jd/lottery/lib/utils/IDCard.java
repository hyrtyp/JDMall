...
public class IDCard
{
  ...
  public String getVerify(String paramString)
  {
    ...
    for (int n = 0;; n++)
    {
      if (n >= 17)
      {
        ...
        return "X";
        label67:
        String str = paramString.substring(m, m + 1);
    ...
    label123:
    return String.valueOf(this.vi[j]);
  }
  ...
  public boolean verify(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramString.length() == 15) {}
        for (String str = uptoeighteen(paramString); (verifyAreaCode(str)) && (verifyBirthdayCode(str)) && (verifyMOD(str)); str = paramString) {
          return true;
        }
      }
    }
  ...
  public boolean verifyBirthdayCode(String paramString)
  {
    ...
    label84:
    for (String str2 = "(11-12位)";; str2 = "(9-10位)")
    {
 ...
 * Qualified Name:     com.jd.lottery.lib.utils.IDCard
