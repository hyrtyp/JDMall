...
public class JSONSerializer2<ModelType extends Model>
{
  public static final String __ = "->\035";
  private final Class<ModelType> cls;
  private Context ctx;
  
  public JSONSerializer2(Class<ModelType> paramClass, Context paramContext)
  {
    this.cls = paramClass;
  ...
  public ModelType deserialize(JSONObject paramJSONObject)
    throws JSONException
  {
    Model localModel = (Model)ReflectionUtils.newInstance(this.cls);
    FieldSpec[] arrayOfFieldSpec = ClassSpecRegistry.getJsonKeySpecs(this.cls);
  ...
  public ArrayList<ModelType> deserialize(JSONArray paramJSONArray)
    throws JSONException
  {
    ...
    for (int i = 0;; i++)
    {
      ...
      localArrayList.add(deserialize(paramJSONArray.getJSONObject(i)));
    }
  }
 ...
 * Qualified Name:     com.jd.droidlib.persist.json.JSONSerializer2
